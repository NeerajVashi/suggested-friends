...
async function createTestData() {
  ...
  await pool.query('create table bookObject ( id int auto_increment, bookName varchar(250), author varchar(250), content varchar(250),isbn varchar(250),images varchar(250),authorId varchar(250), primary key (id))');
